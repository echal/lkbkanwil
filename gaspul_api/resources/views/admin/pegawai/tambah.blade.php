        ...
        <form action="{{ route('admin.pegawai.store') }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <select name="hari_kerja" id="hari_kerja"
                    ...
                    <option value="" {{ old('hari_kerja') === null ? 'selected' : '' }}>— Ikut Unit Kerja —</option>
                    <option value="SENIN_JUMAT" {{ old('hari_kerja') === 'SENIN_JUMAT' ? 'selected' : '' }}>5 Hari (Senin–Jumat)</option>
