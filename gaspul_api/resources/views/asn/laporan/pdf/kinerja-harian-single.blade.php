...
<head>
    ...
    <title>Laporan Kinerja Harian - {{ $tanggal }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="content-section">
        ...
        <table class="detail-table">
            ...
            <tr>
                <td>Rencana Aksi Bulanan</td>
                <td>:</td>
                <td>
                    @if($progres->rencanaAksiBulanan)
                        {{ $progres->rencanaAksiBulanan->rencana_aksi_bulanan }}
                    @else
                        -
                    @endif
                </td>
            ...
            <tr>
                ...
                <td>:</td>
                <td><strong>{{ $progres->rencana_kegiatan_harian }}</strong></td>
            </tr>
            <tr>
                <td>Volume / Output</td>
                <td>:</td>
                <td>
                    <strong style="font-size: 12pt;">{{ $progres->progres }} {{ $progres->satuan }}</strong>
                </td>
            </tr>
            <tr>
    ...
    <!-- Catatan -->
    <div class="note-box">
        <strong>Catatan:</strong> Dokumen ini merupakan bukti pelaksanaan kinerja harian yang telah diinput ke dalam Sistem Informasi Kinerja ASN.
