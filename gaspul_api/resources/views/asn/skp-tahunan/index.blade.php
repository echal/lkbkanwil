...
<div class="space-y-6" x-data="{ deleteId: null }">
    ...
    {{-- Warning Message dari middleware skp.approved --}}
    @if(session('warning'))
        <div class="bg-yellow-50 border-l-4 border-yellow-400 p-4 rounded-lg">
            <div class="flex items-start">
                ...
                <div class="flex-1">
                    ...
                    @if(session('skp_required'))
                        <p class="text-sm text-yellow-700 mt-2">
                            Anda belum dapat mengakses:
                            <strong>Rencana Kerja Bulanan</strong>,
                            <strong>Kinerja Harian</strong>, dan
                            <strong>Laporan Bulanan</strong>
                            sampai SKP Tahunan disetujui atasan.
                        </p>
                        <p class="text-xs text-yellow-600 mt-2">
                            <strong>Catatan:</strong> Anda tetap dapat mengisi <em>Tugas Atasan Langsung (TLA)</em> tanpa perlu SKP disetujui.
                        </p>
                    @endif
                </div>
            </div>
            ...
            <table class="w-full">
                <thead class="bg-gray-50 border-b border-gray-200">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Rencana Hasil Kerja</th>
