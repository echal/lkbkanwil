...
@section('title', 'Edit Tugas Langsung Atasan - Laporan Harian')
@section('page-title', 'Edit Tugas Langsung Atasan')
...
<div class="max-w-3xl mx-auto space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h2 class="text-2xl font-bold text-gray-800">Edit Tugas Langsung Atasan</h2>
    ...
    <form method="POST" action="{{ route('asn.harian.update', $entry->id) }}"
        ...
        <div>
            ...
            <textarea id="tugas_langsung_atasan"
                      ...
                      placeholder="Contoh: Menyiapkan kelengkapan dokumen untuk rapat evaluasi kinerja bulan Januari 2026">{{ old('tugas_langsung_atasan', $entry->tugas_atasan) }}</textarea>
        ...
        <div>
            ...
            <textarea id="keterangan"
                      ...
                      rows="3"
                      class="block w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition resize-none"
                      placeholder="Catatan tambahan atau konteks tugas...">{{ old('keterangan', $entry->keterangan ?? '') }}</textarea>
            @error('keterangan')
            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div class="bg-gray-50 border border-gray-200 rounded-lg p-4">
            <h4 class="text-sm font-medium text-gray-700 mb-2">Status Setelah Update:</h4>
