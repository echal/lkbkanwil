...
<head>
    ...
    <title>Monitoring SKP eSARAku — Kankemenag Mamuju Tengah {{ $tahun }}</title>
        ...
        <div class="flex items-center justify-between gap-4">
            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-green-200 font-semibold text-base mt-0.5">KANKEMENAG KABUPATEN MAMUJU TENGAH &nbsp;·&nbsp; TAHUN {{ $tahun }}</p>
                </div>
            </div>
            {{-- Info kanan --}}
