    ...
    <div class="p-6">
        ...
        <nav class="space-y-2">
            ...
            <a href="{{ $dashboardRoute }}"
               class="flex items-center px-4 py-3 rounded-lg transition duration-200 {{ $isDashboardActive ? 'bg-white text-green-700 shadow-lg' : 'text-white hover:bg-green-600' }}">
            ...
            <div class="pt-4">
                <p class="px-4 text-xs font-semibold text-green-200 uppercase tracking-wider mb-2">
            ...
            <!-- Atasan Monitoring Menu -->
            <div class="pt-4 border-t border-green-600 mt-4">
                <p class="px-4 text-xs font-semibold text-green-200 uppercase tracking-wider mb-2 mt-2">Monitoring Bawahan</p>

                <!-- SKP Bawahan (Approval) -->
                <a href="{{ route('atasan.skp-tahunan.index') }}"
                   class="flex items-center px-4 py-3 rounded-lg transition duration-200 {{ request()->routeIs('atasan.skp-tahunan.*') ? 'bg-white text-green-700 shadow-lg' : 'text-white hover:bg-green-600' }}">
                    ...
                    <span class="font-medium">SKP Bawahan</span>
                </a>
